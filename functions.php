...
add_filter( 'stencil:require', 'savant3_theme_implementation' );

// Load the router, which handles running controllers.
add_action( 'after_setup_theme', 'savant3_theme_router' );
 ...
 * @return string
 */
function savant3_theme_implementation() {
	return 'Savant 3';
}
